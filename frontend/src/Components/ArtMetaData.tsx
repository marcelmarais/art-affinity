...
const SaleInfoLine: React.FC<DetailsProps> = ({ price }) => {
  return (
...
const TitleLine: React.FC<DetailsProps> = ({ title, date }) => {
  return (
...
const PartnerLine: React.FC<DetailsProps> = ({ galleryName }) => {
  if (galleryName) {
    return (
...
const ArtistLine: React.FC<DetailsProps> = ({ artistName }) => {
  return (
...
export const Details: React.FC<DetailsProps> = ({ ...rest }) => {
